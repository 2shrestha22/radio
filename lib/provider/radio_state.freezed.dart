...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RadioState&&(identical(other.station, station) || other.station == station)&&(identical(other.playerState, playerState) || other.playerState == playerState)&&(identical(other.streamingState, streamingState) || other.streamingState == streamingState)&&(identical(other.title, title) || other.title == title)&&(identical(other.bitRate, bitRate) || other.bitRate == bitRate)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,station,playerState,streamingState,title,bitRate,error);
...
@useResult
$Res call({
 RadioStation? station, RadioPlayerState playerState, StreamingState? streamingState, String? title, int? bitRate, RadioPlayerException? error
});
...
/// Create a copy of RadioState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? station = freezed,Object? playerState = null,Object? streamingState = freezed,Object? title = freezed,Object? bitRate = freezed,Object? error = freezed,}) {
  return _then(_self.copyWith(
station: freezed == station ? _self.station : station // ignore: cast_nullable_to_non_nullable
as RadioStation?,playerState: null == playerState ? _self.playerState : playerState // ignore: cast_nullable_to_non_nullable
as RadioPlayerState,streamingState: freezed == streamingState ? _self.streamingState : streamingState // ignore: cast_nullable_to_non_nullable
as StreamingState?,title: freezed == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( RadioStation? station,  RadioPlayerState playerState,  StreamingState? streamingState,  String? title,  int? bitRate,  RadioPlayerException? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RadioState() when $default != null:
return $default(_that.station,_that.playerState,_that.streamingState,_that.title,_that.bitRate,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( RadioStation? station,  RadioPlayerState playerState,  StreamingState? streamingState,  String? title,  int? bitRate,  RadioPlayerException? error)  $default,) {final _that = this;
switch (_that) {
case _RadioState():
return $default(_that.station,_that.playerState,_that.streamingState,_that.title,_that.bitRate,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( RadioStation? station,  RadioPlayerState playerState,  StreamingState? streamingState,  String? title,  int? bitRate,  RadioPlayerException? error)?  $default,) {final _that = this;
switch (_that) {
case _RadioState() when $default != null:
return $default(_that.station,_that.playerState,_that.streamingState,_that.title,_that.bitRate,_that.error);case _:
  return null;
...
class _RadioState implements RadioState {
  const _RadioState({this.station, this.playerState = RadioPlayerState.idle, this.streamingState, this.title, this.bitRate, this.error});
...
@override final  RadioPlayerException? error;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RadioState&&(identical(other.station, station) || other.station == station)&&(identical(other.playerState, playerState) || other.playerState == playerState)&&(identical(other.streamingState, streamingState) || other.streamingState == streamingState)&&(identical(other.title, title) || other.title == title)&&(identical(other.bitRate, bitRate) || other.bitRate == bitRate)&&(identical(other.error, error) || other.error == error));
}
...
/// Create a copy of RadioState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? station = freezed,Object? playerState = null,Object? streamingState = freezed,Object? title = freezed,Object? bitRate = freezed,Object? error = freezed,}) {
